...
RIZ_IMG = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/spambot-12-16"


Riz_Button = [
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/Innocent_Gaurav"),
